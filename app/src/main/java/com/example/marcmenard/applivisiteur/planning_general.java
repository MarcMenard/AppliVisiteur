...
public class planning_general extends AppCompatActivity {
    ListView vue;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_planning_general);
    ...
    */
            String[][] repertoire = new String[][]{
                    {"Groupe 1", "Loroux Bottereau"},
                    {"Groupe 2", "Ligné"},
                    {"Groupe 3", "St Médard de Doulon"}};
